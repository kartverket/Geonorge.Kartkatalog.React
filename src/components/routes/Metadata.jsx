    ...
    const renderMetadataDateUpdated = () => {
        return metadata?.DateMetadataUpdated?.length ? (
            <div>
                ...
                {metadata?.DateMetadataUpdated && moment(metadata.DateMetadataUpdated).isValid()
                    ? moment(metadata.DateMetadataUpdated).format("DD.MM.YYYY")
                    : null}
            </div>
        ) : null;
    };
    ...
    const renderDatePublished = () => {
        return metadata?.DatePublished?.length ? (
            <div>
                ...
                {metadata?.DatePublished && moment(metadata.DatePublished).isValid()
                    ? moment(metadata.DatePublished).format("DD.MM.YYYY")
                    : null}
            </div>
        ) : null;
    };
